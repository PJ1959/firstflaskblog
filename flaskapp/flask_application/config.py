...
class Config(object):
    def __init__(self):
        ...
        self.SITE_ROOT_URL = 'http://example.com'
        ...
        self.MONGODB_DB = 'testing'
        self.MONGODB_HOST = 'localhost'
        self.MONGODB_PORT = 27017

        # Configured for Gmail
        self.DEFAULT_MAIL_SENDER = 'Admin < jeyasunderam@gmail.com >'
        self.MAIL_SERVER = 'smtp.gmail.com'
        self.MAIL_PORT = 465
        self.MAIL_USE_SSL = True
        self.MAIL_USERNAME = 'jeyasunderam@gmail.com'
        self.MAIL_PASSWORD = 'password'

        # Flask-Security setup
        self.SECURITY_EMAIL_SENDER = 'Security < jeyasunderam@gmail.com >'
...
class ProductionConfig(Config):
    def __init__(self):
        ...
        self.MONGODB_SETTINGS = self.mongo_from_uri(os.getenv('MONGOLAB_URL'))
